package pl.jmekarska.sales.offering;
...
import pl.jmekarska.sales.cart.CartItem;
...
public class OfferCalculatorTest {
    ...
    public void itCreateOfferBasedOnCartItems() {
        String product1 = thereIsProduct("Tshirt 1", BigDecimal.valueOf(10.10));
        String product2 = thereIsProduct("Tshirt 2", BigDecimal.valueOf(20.10));
    ...
    public void itAllowsToApplyTotalDiscount() {
        String product1 = thereIsProduct("Tshirt 1", BigDecimal.valueOf(100));
        List<CartItem> cartItems = Arrays.asList(
